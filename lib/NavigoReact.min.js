...
/*!*****************************!*\
  !*** ./src/NavigoReact.tsx ***!
  \*****************************/
/*! exports provided: getRouter, configureRouter, reset, Route, Base, Switch, NotFound, Redirect, useNavigo, useLocation */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useNavigo", function() { return useNavigo; });
...
let router;
let Context = react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext({ match: false });
let SwitchContext = react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext({ isInSwitch: false, switchMatch: false });
function getRouter(root) {
    if (router) {
        return router;
    }
    router = new navigo__WEBPACK_IMPORTED_MODULE_1___default.a(root || "/", { strategy: "ALL", noMatchWarning: true });
...
function Route({ path, children, loose, before, after, already, leave }) {
    const [context, setContext] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useReducer"])((state, action) => ({ ...state, ...action }), {
        match: false,
    });
    const switchContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(SwitchContext);
    const renderChild = () => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Context.Provider, { value: context }, children);
    const noneBlockingHook = (func) => (match) => {
        func((result) => {
    ...
    const blockingHook = (func) => (done, match) => {
        func((result) => {
    ...
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        ...
        router.addLeaveHook(navigoRoute, (done) => {
            if (isMounted) {
...
function Switch({ children }) {
    const [match, setMatch] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SwitchContext.Provider, { value: { switchMatch: false, isInSwitch: true }, key: match ? match.url : `switch${new Date().getTime()}` }, children));
}
function NotFound({ children, hooks }) {
    const match = useNotFound(hooks);
    if (match) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Context.Provider, { value: { match } }, children);
    }
    return null;
}
...
function useNotFound(hooks) {
    const [match, setMatch] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
    const handler = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])((match) => {
        setMatch(match);
        nextTick(() => getRouter().updatePageLinks());
    });
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        ...
        router.addLeaveHook("__NOT_FOUND__", (done) => {
            setMatch(false);
            done();
        });
        router.resolve();
...
/***/ 0:
/*!***********************************!*\
  !*** multi ./src/NavigoReact.tsx ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/krasimir/Work/Krasimir/navigo-react/src/NavigoReact.tsx */"./src/NavigoReact.tsx");
